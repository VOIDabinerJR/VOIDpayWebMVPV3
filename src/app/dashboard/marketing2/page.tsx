    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="cashback" className="w-full">
        <TabsList className="grid w-full grid-cols-4 lg:grid-cols-9 h-auto p-1 bg-muted/50">
          ...
          >
            <IconDiscount className="h-4 w-4 mr-1" />
            Cupons
          </TabsTrigger>
          <TabsTrigger 
            value="orderBumps" 
          ...
          >
            <IconTags className="h-4 w-4 mr-1" />
            Descontos
          </TabsTrigger>
          <TabsTrigger 
            value="pixels" 
          ...
          >
            <IconDeviceAnalytics className="h-4 w-4 mr-1" />
            Pixels
          </TabsTrigger>
          <TabsTrigger 
            value="promotions" 
              ...
              <div className="lg:col-span-2 space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="cashback-minimum">Valor Mínimo da Compra</Label>
                      <Input id="cashback-minimum" placeholder="Ex: 100" prefix="MZN" />
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="cashback-expiry">Validade do Cashback</Label>
                      <Select>
                        <SelectTrigger>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Defina regras específicas para diferentes produtos ou clientes
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground">Último cashback:</span>
                ...
                <Card>
                  ...
                  <CardContent className="bg-muted/50 p-4 rounded-lg">
                    <div className="border rounded-md p-4 bg-background">
                      <h3 className="font-medium">Ganhe cashback nesta compra!</h3>
                      <p className="text-sm text-muted-foreground mt-1">
                        Receba 10% de volta em sua carteira VOIDpay para usar em futuras compras.
                      </p>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input id="coupon-code" placeholder="Ex: BLACKFRIDAY20" />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="coupon-minimum" placeholder="Ex: 100" prefix="MZN" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="coupon-uses" type="number" placeholder="Ilimitado se vazio" />
                    </div>

                    <Button className="w-full mt-4">Criar Cupom</Button>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        {[1, 2, 3].map((item) => (
                          <TableRow key={item}>
                            <TableCell className="font-medium">SUMMER{item}0</TableCell>
                            <TableCell>{item}0% OFF</TableCell>
                            <TableCell>{item}2/{item*20}</TableCell>
                            <TableCell>3{item}/0{item}/2023</TableCell>
                            <TableCell>
                  ...
                  <CardContent className="bg-muted/50 p-4 rounded-lg">
                    <div className="border rounded-md p-4 bg-background">
                      ...
                      <div className="flex mt-2 gap-2">
                        <Input placeholder="Insira o código" className="flex-1" />
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          <SelectItem value="product1">Garrafa Térmica</SelectItem>
                          <SelectItem value="product2">Capa Protetora</SelectItem>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          <SelectItem value="after-shipping">Após informações de envio</SelectItem>
                          <SelectItem value="before-payment">Antes do pagamento</SelectItem>
                          <SelectItem value="order-review">Na revisão do pedido</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="ob-offer" placeholder="Ex: 20% OFF se comprado agora!" />
                    </div>

                    <div className="flex items-center space-x-2">
                      <Switch id="ob-limited" />
                      <Label htmlFor="ob-limited">Oferta por tempo limitado</Label>
                    </div>

                    <Button className="w-full mt-4">Criar Order Bump</Button>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="bg-muted/50 p-4 rounded-lg">
                    <div className="border rounded-md p-4 bg-background">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-medium">Garrafa Térmica Premium</h3>
                          <p className="text-sm text-muted-foreground">Mantenha suas bebidas quentes por 12h</p>
                          <div className="flex items-center mt-1 gap-2">
                            <span className="font-medium">MZN 250.00</span>
                            <span className="text-sm line-through text-muted-foreground">MZN 300.00</span>
                      ...
                      <div className="mt-3 flex items-center justify-between">
                        <div className="text-sm text-success">
                          <strong>Oferta especial!</strong> Adicione ao seu pedido.
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="bundle-discount">Desconto do Pacote</Label>
                      <Input id="bundle-discount" placeholder="Ex: 15" />
                    </div>

                    <div className="flex items-center space-x-2">
                      <Switch id="bundle-limited" />
                      <Label htmlFor="bundle-limited">Oferta por tempo limitado</Label>
                    </div>

                    <Button className="w-full mt-4">Criar Pacote</Button>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <Table>
                      ...
                      <TableBody>
                        {[1, 2].map((item) => (
                          <TableRow key={item}>
                            <TableCell className="font-medium">Pacote {item}</TableCell>
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="bg-muted/50 p-4 rounded-lg">
                    <div className="border rounded-md p-4 bg-background">
                      <h3 className="font-medium">Frequentemente comprados juntos</h3>
                      ...
                      <Button className="w-full mt-3">Adicionar ao Carrinho</Button>
                    </div>
                  </CardContent>
                </Card>
              </div>
