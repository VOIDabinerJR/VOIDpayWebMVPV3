...
import { IconDeviceAnalytics, IconPlus, IconTrash, IconEdit } from '@tabler/icons-react';
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure pixels para acompanhar conversões e otimizar suas campanhas
          </CardDescription>
        </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="pixel-platform" placeholder="Ex: Facebook, Google Ads, TikTok" />
              </div>
              <div className="space-y-2">
            ...
            <div className="border rounded-lg p-4 bg-muted/50">
              <h3 className="font-medium mb-2">Como encontrar seu Pixel ID:</h3>
              <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                <li>Acesse o Business Manager do Facebook ou Google Ads</li>
                <li>Navegue até a seção "Pixels" ou "Tags"</li>
                <li>Copie o ID do pixel (geralmente começa com "FB" ou "G-")</li>
              ...
              <TableBody>
                {pixels.map((pixel) => (
                  <TableRow key={pixel.id}>
                    <TableCell className="font-medium">{pixel.platform}</TableCell>
                    <TableCell>{pixel.pixelId}</TableCell>
                    <TableCell>
                      <Badge variant={pixel.status === 'active' ? 'default' : 'destructive'}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card>
              ...
              <CardContent className="p-4 pt-0">
                ...
                <p className="text-muted-foreground text-xs">+2% em relação à semana anterior</p>
              </CardContent>
            </Card>
          </div>
        </CardContent>
