            ...
            <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7'>
              <div className='col-span-4'>
                <Card>
                  <CardHeader>
                    <CardTitle>
                      {estatisticas.visaoGeralGanhos.titulo}
                    </CardTitle>
                    <CardDescription>
              ...
              <div className='grid grid-cols-1 gap-4 px-6 pb-4 md:grid-cols-2 lg:grid-cols-3'>
                <div className='rounded-lg border p-4'>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    Seus produtos mais vendidos estão com estoque baixo.
                    Considere repor.
                  </p>
                </div>
                <div className='rounded-lg border p-4'>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    Problemas com pagamentos? Contate nosso suporte
                    imediatamente.
                  </p>
                </div>
                <div className='rounded-lg border p-4'>
                  ...
                  <p className='text-muted-foreground text-sm'>
                    Nova atualização disponível! Melhorias no painel de
                    controle.
                  </p>
                </div>
              </div>
            </Card>
            {/* ...rest of the estatisticas cards and content... */}
          </>
        ) : (
